...
atoo(const char *s)
{
 ...
 381:	7e 0a                	jle    38d <atoo+0x85>
 383:	8b 45 08             	mov    0x8(%ebp),%eax
 386:	0f b6 00             	movzbl (%eax),%eax
 389:	3c 39                	cmp    $0x39,%al
 38b:	7e cb                	jle    358 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
 38d:	8b 45 f8             	mov    -0x8(%ebp),%eax
 390:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 394:	c9                   	leave  
 395:	c3                   	ret    
