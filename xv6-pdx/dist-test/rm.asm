...
atoo(const char *s)
{
 ...
 39d:	7e 0a                	jle    3a9 <atoo+0x85>
 39f:	8b 45 08             	mov    0x8(%ebp),%eax
 3a2:	0f b6 00             	movzbl (%eax),%eax
 3a5:	3c 39                	cmp    $0x39,%al
 3a7:	7e cb                	jle    374 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
