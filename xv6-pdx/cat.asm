...
atoo(const char *s)
{
 ...
 41a:	3c 2f                	cmp    $0x2f,%al
 41c:	7e 0a                	jle    428 <atoo+0x85>
 41e:	8b 45 08             	mov    0x8(%ebp),%eax
 421:	0f b6 00             	movzbl (%eax),%eax
 424:	3c 39                	cmp    $0x39,%al
 426:	7e cb                	jle    3f3 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
 428:	8b 45 f8             	mov    -0x8(%ebp),%eax
 42b:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 42f:	c9                   	leave  
 430:	c3                   	ret    
