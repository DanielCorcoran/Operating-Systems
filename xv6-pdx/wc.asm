...
atoo(const char *s)
{
 ...
 457:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  while (*s == ' ') s++;
 45e:	eb 04                	jmp    464 <atoo+0x13>
 460:	83 45 08 01          	addl   $0x1,0x8(%ebp)
 464:	8b 45 08             	mov    0x8(%ebp),%eax
 467:	0f b6 00             	movzbl (%eax),%eax
 46a:	3c 20                	cmp    $0x20,%al
 46c:	74 f2                	je     460 <atoo+0xf>
  sign = (*s == '-') ? -1 : 1;
 46e:	8b 45 08             	mov    0x8(%ebp),%eax
 471:	0f b6 00             	movzbl (%eax),%eax
 474:	3c 2d                	cmp    $0x2d,%al
 476:	75 07                	jne    47f <atoo+0x2e>
 478:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 47d:	eb 05                	jmp    484 <atoo+0x33>
 47f:	b8 01 00 00 00       	mov    $0x1,%eax
 484:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if (*s == '+'  || *s == '-')
 487:	8b 45 08             	mov    0x8(%ebp),%eax
 48a:	0f b6 00             	movzbl (%eax),%eax
 48d:	3c 2b                	cmp    $0x2b,%al
 48f:	74 0a                	je     49b <atoo+0x4a>
 491:	8b 45 08             	mov    0x8(%ebp),%eax
 494:	0f b6 00             	movzbl (%eax),%eax
 497:	3c 2d                	cmp    $0x2d,%al
 499:	75 27                	jne    4c2 <atoo+0x71>
    s++;
 49b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
  while('0' <= *s && *s <= '9')
 49f:	eb 21                	jmp    4c2 <atoo+0x71>
    n = n*8 + *s++ - '0';
 4a1:	8b 45 fc             	mov    -0x4(%ebp),%eax
 4a4:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
 ...
 4c8:	3c 2f                	cmp    $0x2f,%al
 4ca:	7e 0a                	jle    4d6 <atoo+0x85>
 4cc:	8b 45 08             	mov    0x8(%ebp),%eax
 4cf:	0f b6 00             	movzbl (%eax),%eax
 4d2:	3c 39                	cmp    $0x39,%al
 4d4:	7e cb                	jle    4a1 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
 4d6:	8b 45 f8             	mov    -0x8(%ebp),%eax
 4d9:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 4dd:	c9                   	leave  
 4de:	c3                   	ret    
