...
atoo(const char *s)
{
 ...
 331:	7e 0a                	jle    33d <atoo+0x85>
 333:	8b 45 08             	mov    0x8(%ebp),%eax
 336:	0f b6 00             	movzbl (%eax),%eax
 339:	3c 39                	cmp    $0x39,%al
 33b:	7e cb                	jle    308 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
 33d:	8b 45 f8             	mov    -0x8(%ebp),%eax
 340:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 344:	c9                   	leave  
 345:	c3                   	ret    
