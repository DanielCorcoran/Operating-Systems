...
atoo(const char *s)
{
 ...
 339:	7e 0a                	jle    345 <atoo+0x85>
 33b:	8b 45 08             	mov    0x8(%ebp),%eax
 33e:	0f b6 00             	movzbl (%eax),%eax
 341:	3c 39                	cmp    $0x39,%al
 343:	7e cb                	jle    310 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
