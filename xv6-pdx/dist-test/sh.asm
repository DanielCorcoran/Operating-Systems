...
atoo(const char *s)
{
  ...
  while (*s == ' ') s++;
    1237:	eb 04                	jmp    123d <atoo+0x13>
    1239:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    123d:	8b 45 08             	mov    0x8(%ebp),%eax
    1240:	0f b6 00             	movzbl (%eax),%eax
    1243:	3c 20                	cmp    $0x20,%al
    1245:	74 f2                	je     1239 <atoo+0xf>
  sign = (*s == '-') ? -1 : 1;
    1247:	8b 45 08             	mov    0x8(%ebp),%eax
    124a:	0f b6 00             	movzbl (%eax),%eax
    124d:	3c 2d                	cmp    $0x2d,%al
    124f:	75 07                	jne    1258 <atoo+0x2e>
    1251:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1256:	eb 05                	jmp    125d <atoo+0x33>
    1258:	b8 01 00 00 00       	mov    $0x1,%eax
    125d:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if (*s == '+'  || *s == '-')
    1260:	8b 45 08             	mov    0x8(%ebp),%eax
    1263:	0f b6 00             	movzbl (%eax),%eax
    1266:	3c 2b                	cmp    $0x2b,%al
    1268:	74 0a                	je     1274 <atoo+0x4a>
    126a:	8b 45 08             	mov    0x8(%ebp),%eax
    126d:	0f b6 00             	movzbl (%eax),%eax
    1270:	3c 2d                	cmp    $0x2d,%al
    1272:	75 27                	jne    129b <atoo+0x71>
    s++;
    1274:	83 45 08 01          	addl   $0x1,0x8(%ebp)
  while('0' <= *s && *s <= '9')
    1278:	eb 21                	jmp    129b <atoo+0x71>
    n = n*8 + *s++ - '0';
    127a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    127d:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
    1284:	8b 45 08             	mov    0x8(%ebp),%eax
    1287:	8d 50 01             	lea    0x1(%eax),%edx
    128a:	89 55 08             	mov    %edx,0x8(%ebp)
  ...
  while('0' <= *s && *s <= '9')
    ...
    12a1:	3c 2f                	cmp    $0x2f,%al
    12a3:	7e 0a                	jle    12af <atoo+0x85>
    12a5:	8b 45 08             	mov    0x8(%ebp),%eax
    12a8:	0f b6 00             	movzbl (%eax),%eax
    12ab:	3c 39                	cmp    $0x39,%al
    12ad:	7e cb                	jle    127a <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
    12af:	8b 45 f8             	mov    -0x8(%ebp),%eax
    12b2:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
    12b6:	c9                   	leave  
    12b7:	c3                   	ret    
