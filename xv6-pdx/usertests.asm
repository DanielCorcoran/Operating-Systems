...
atoo(const char *s)
{
    ...
    3f0f:	83 ec 10             	sub    $0x10,%esp
  int n, sign;

  n = 0;
    3f12:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  while (*s == ' ') s++;
    3f19:	eb 04                	jmp    3f1f <atoo+0x13>
    3f1b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
    3f1f:	8b 45 08             	mov    0x8(%ebp),%eax
    3f22:	0f b6 00             	movzbl (%eax),%eax
    3f25:	3c 20                	cmp    $0x20,%al
    3f27:	74 f2                	je     3f1b <atoo+0xf>
  sign = (*s == '-') ? -1 : 1;
    3f29:	8b 45 08             	mov    0x8(%ebp),%eax
    3f2c:	0f b6 00             	movzbl (%eax),%eax
    3f2f:	3c 2d                	cmp    $0x2d,%al
    3f31:	75 07                	jne    3f3a <atoo+0x2e>
    3f33:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    3f38:	eb 05                	jmp    3f3f <atoo+0x33>
    3f3a:	b8 01 00 00 00       	mov    $0x1,%eax
    3f3f:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if (*s == '+'  || *s == '-')
    3f42:	8b 45 08             	mov    0x8(%ebp),%eax
    3f45:	0f b6 00             	movzbl (%eax),%eax
    3f48:	3c 2b                	cmp    $0x2b,%al
    3f4a:	74 0a                	je     3f56 <atoo+0x4a>
    3f4c:	8b 45 08             	mov    0x8(%ebp),%eax
    3f4f:	0f b6 00             	movzbl (%eax),%eax
    3f52:	3c 2d                	cmp    $0x2d,%al
    3f54:	75 27                	jne    3f7d <atoo+0x71>
    s++;
    3f56:	83 45 08 01          	addl   $0x1,0x8(%ebp)
  while('0' <= *s && *s <= '9')
    3f5a:	eb 21                	jmp    3f7d <atoo+0x71>
    n = n*8 + *s++ - '0';
    3f5c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3f5f:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
    3f66:	8b 45 08             	mov    0x8(%ebp),%eax
    3f69:	8d 50 01             	lea    0x1(%eax),%edx
    3f6c:	89 55 08             	mov    %edx,0x8(%ebp)
    3f6f:	0f b6 00             	movzbl (%eax),%eax
    3f72:	0f be c0             	movsbl %al,%eax
    3f75:	01 c8                	add    %ecx,%eax
    3f77:	83 e8 30             	sub    $0x30,%eax
    3f7a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  n = 0;
  while (*s == ' ') s++;
  sign = (*s == '-') ? -1 : 1;
  if (*s == '+'  || *s == '-')
  ...
  while('0' <= *s && *s <= '9')
    ...
    3f83:	3c 2f                	cmp    $0x2f,%al
    3f85:	7e 0a                	jle    3f91 <atoo+0x85>
    3f87:	8b 45 08             	mov    0x8(%ebp),%eax
    3f8a:	0f b6 00             	movzbl (%eax),%eax
    3f8d:	3c 39                	cmp    $0x39,%al
    3f8f:	7e cb                	jle    3f5c <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
    3f91:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3f94:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
    3f98:	c9                   	leave  
    3f99:	c3                   	ret    
