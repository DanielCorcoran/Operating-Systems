...
atoo(const char *s)
{
 ...
 5cd:	83 ec 10             	sub    $0x10,%esp
  ...
  n = 0;
 5d0:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
  while (*s == ' ') s++;
 5d7:	eb 04                	jmp    5dd <atoo+0x13>
 5d9:	83 45 08 01          	addl   $0x1,0x8(%ebp)
 5dd:	8b 45 08             	mov    0x8(%ebp),%eax
 5e0:	0f b6 00             	movzbl (%eax),%eax
 5e3:	3c 20                	cmp    $0x20,%al
 5e5:	74 f2                	je     5d9 <atoo+0xf>
  sign = (*s == '-') ? -1 : 1;
 5e7:	8b 45 08             	mov    0x8(%ebp),%eax
 5ea:	0f b6 00             	movzbl (%eax),%eax
 5ed:	3c 2d                	cmp    $0x2d,%al
 5ef:	75 07                	jne    5f8 <atoo+0x2e>
 5f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 5f6:	eb 05                	jmp    5fd <atoo+0x33>
 5f8:	b8 01 00 00 00       	mov    $0x1,%eax
 5fd:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if (*s == '+'  || *s == '-')
 600:	8b 45 08             	mov    0x8(%ebp),%eax
 603:	0f b6 00             	movzbl (%eax),%eax
 606:	3c 2b                	cmp    $0x2b,%al
 608:	74 0a                	je     614 <atoo+0x4a>
 60a:	8b 45 08             	mov    0x8(%ebp),%eax
 60d:	0f b6 00             	movzbl (%eax),%eax
 610:	3c 2d                	cmp    $0x2d,%al
 612:	75 27                	jne    63b <atoo+0x71>
    s++;
 614:	83 45 08 01          	addl   $0x1,0x8(%ebp)
  while('0' <= *s && *s <= '9')
 618:	eb 21                	jmp    63b <atoo+0x71>
    n = n*8 + *s++ - '0';
 61a:	8b 45 fc             	mov    -0x4(%ebp),%eax
 61d:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
