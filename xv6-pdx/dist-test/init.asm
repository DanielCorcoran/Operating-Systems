...
atoo(const char *s)
{
 ...
 40e:	7e 0a                	jle    41a <atoo+0x85>
 410:	8b 45 08             	mov    0x8(%ebp),%eax
 413:	0f b6 00             	movzbl (%eax),%eax
 416:	3c 39                	cmp    $0x39,%al
 418:	7e cb                	jle    3e5 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
 41a:	8b 45 f8             	mov    -0x8(%ebp),%eax
 41d:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 421:	c9                   	leave  
 422:	c3                   	ret    
