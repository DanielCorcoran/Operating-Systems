...
atoo(const char *s)
{
 ...
 468:	3c 2f                	cmp    $0x2f,%al
 46a:	7e 0a                	jle    476 <atoo+0x85>
 46c:	8b 45 08             	mov    0x8(%ebp),%eax
 46f:	0f b6 00             	movzbl (%eax),%eax
 472:	3c 39                	cmp    $0x39,%al
 474:	7e cb                	jle    441 <atoo+0x50>
    n = n*8 + *s++ - '0';
  return sign*n;
 476:	8b 45 f8             	mov    -0x8(%ebp),%eax
 479:	0f af 45 fc          	imul   -0x4(%ebp),%eax
}
 47d:	c9                   	leave  
 47e:	c3                   	ret    
